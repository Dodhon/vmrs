VMRS interface evaluation summary
...
- Ground truth used for scoring (vendor to VMRS mapping): vendor data/checked/Motors Part Cleanup - Return Data.csv
...
- Description (partial text) (description_partial)
  ...
  - How the partial description text was created:
    ...
    - Example: full description "DRIVERS SIDE SEAT BELT" becomes partial description "DRIVERS SIDE SEAT".
...
- VP-51dc6a: vendor CSV contains ZT-105-RONT|STELLANA mapped to 017-005-002, but the transcript returned NOT_FOUND.
...
Important note on validation_invalid
